...
// в это событие попадает как переход на другую страницу (pageIndex), так и изменение кол-ва данных на страниц (pageSize)
    ...
    initSearch() {
        ...
        this.taskSearchValues.priority = this.filterPriorityId;
    ...
    checkFilterChanged() {
        ...
        if (this.taskSearchValues.priority !== this.filterPriorityId) {
            this.changed = true;
        }
    ...
    initSearchValues() {
        ...
        this.filterPriorityId = this.taskSearchValues.priority;
